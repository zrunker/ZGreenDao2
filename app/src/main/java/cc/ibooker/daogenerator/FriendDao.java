...
public class FriendDao extends AbstractDao<Friend, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FGname = new Property(1, String.class, "fGname", false, "F_GNAME");
        public final static Property FUid = new Property(2, Long.class, "fUid", false, "F_UID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIEND\" (" + //
                ...
                "\"F_GNAME\" TEXT," + // 1: fGname
                "\"F_UID\" INTEGER);"); // 2: fUid
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Friend entity) {
        ...
        String fGname = entity.getFGname();
        if (fGname != null) {
            stmt.bindString(2, fGname);
        }
 
        Long fUid = entity.getFUid();
        if (fUid != null) {
            stmt.bindLong(3, fUid);
        }
    }
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // fGname
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2) // fUid
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setFGname(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setFUid(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN USER T0 ON T.\"F_UID\"=T0.\"_id\"");
            builder.append(' ');
